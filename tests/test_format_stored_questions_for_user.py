import unittest
import os
from diary_tool import format_stored_questions_for_user
...
class TestFormatStoredQuestionsForUser(unittest.TestCase):
    def test_format_stored_questions_for_user(self):
        ...
        testfile_path = current_file_path.replace('test_format_stored_questions_for_user.py', 'tesfile_for_func_format_stored_questions_for_user')
